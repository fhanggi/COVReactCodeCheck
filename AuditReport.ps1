...
$databasePath = "C:\FabianWorkSpaceGit\COVReactCodeCheck\COVReactCodeCheck.db"
$jsonFilePath = "C:\FabianWorkSpaceGit\COVReactCodeCheck\my-react-app\audit-report.json"
$packagePath = "C:\FabianWorkSpaceGit\COVReactCodeCheck\my-react-app\package.json"
$tempSqlFile = "C:\FabianWorkSpaceGit\COVReactCodeCheck\temp_insert.sql"
$sqlLitePath = "C:\FabianWorkSpaceGit\COVReactCodeCheck\sqlite3.exe"  # Path to sqlite3.exe
...
& $sqlLitePath $databasePath ".read $tempSqlFile"
